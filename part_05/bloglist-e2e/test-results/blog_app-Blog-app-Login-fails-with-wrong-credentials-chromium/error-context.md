...
- Location: tests\blog_app.spec.js:43:5
...
Expected substring: "wrong username or password"
Received string:    "invalid username or password"
Timeout: 5000ms

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for locator('.error')
    11 × locator resolved to <div class="error">invalid username or password</div>
       - unexpected value "invalid username or password"
